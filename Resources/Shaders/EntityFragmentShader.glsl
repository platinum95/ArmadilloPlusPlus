...
flat in vec2 vFragTextureCoords;
...
void main()
{	
	vec4 vTextureColour = texture2D(uTexture, vFragTextureCoords);
	...
	FragColor = ConvertLightToVec4(CalculateLight(sLights[0], vFragNormal, vToViewVector, vFragPosition), vTextureColour);
